<?php 
	...
	echo "Nama : ".$person -> nama="Adya Zalfa Zahirah";
	echo "<br>";
	echo "Asal : ".$person -> asal="Kaliwates Jember";
	echo "<br>";
	echo "Nilai Matematika :" .$person -> matematika="88";
	echo "<br>";
	echo "Nilai Fisika :" .$person -> fisika="80";
	echo "<br>";
	echo "Nilai Kimia : " .$person -> kimia="87";
	echo "<br>";
	echo "Nilai Bhs. Inggris : " .$person -> inggris="91";
	echo "<br>";
	echo "Nilai Biologi : " .$person -> biologi="84";
	echo "<br>";
